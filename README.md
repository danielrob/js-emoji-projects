...
- 🏆 - [uiengine](https://github.com/dennisreimann/uiengine) - Workbench for UI-driven development. Currently wins the "emojis in commit messages" award, as well as excellent use of emoji's in the documentation. 
